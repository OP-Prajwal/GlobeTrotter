...
export default function ItineraryBuilder(props: { params: Promise<{ tripId: string }> }) {
    ...
    const handleSave = async () => {
        setIsSaving(true)
        try {
            const result = await saveItinerary(params.tripId, sections)
            if (result.success) {
                alert("Itinerary Saved Successfully!") // Simple feedback for now
            } else {
