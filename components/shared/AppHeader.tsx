...
export default function AppHeader({ userEmail: initialEmail }: AppHeaderProps) {
    ...
    return (
        <header className="border-b border-white/10 p-4 sticky top-0 bg-black/80 backdrop-blur-md z-50 shrink-0">
            <div className="max-w-7xl mx-auto flex justify-between items-center">
                ...
                <Link href="/profile" className="flex items-center gap-4 hover:opacity-80 transition-opacity cursor-pointer">
                    <span className="text-sm text-gray-400 hidden md:block">Hello, {userEmail?.split('@')[0] || 'Traveler'}</span>
